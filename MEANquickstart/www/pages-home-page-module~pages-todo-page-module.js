(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-home-page-module~pages-todo-page-module"],{
...
/***/ "./src/app/shared/form-modules/login-form/login-form.component.html":
/*!**************************************************************************!*\
  !*** ./src/app/shared/form-modules/login-form/login-form.component.html ***!
  \**************************************************************************/
...
module.exports = "<!-- \nAfficher la section quand l'objet formObject à récupérer la valeur du parent\n-->\n<section *ngIf=\"formObject\">\n  <h2 (click)=\"formIsOpen = !formIsOpen\">Connexion</h2>\n\n  <!-- \n  Création d'un formuliare d'inscription\n  - Utilisation du ngModel pour le data binding des valeurs des inputs\n  -->\n  <form (submit)=\"formSubmission()\"  [ngClass]=\"{ 'open': formIsOpen }\" >\n    <label for=\"email\">Votre adresse mail  <span *ngIf=\"formError.email\">Obligatoire</span></label>\n    <input type=\"email\" name=\"email\" [(ngModel)]=\"formObject.email\" (focus)=\"formError.email = false\">\n\n    <label for=\"password\">Votre mot de passe  <span *ngIf=\"formError.password\">Obligatoire</span></label>\n    <input type=\"password\" name=\"password\" [(ngModel)]=\"formObject.password\" (focus)=\"formError.password = false\">\n\n    <button type=\"submit\">Connexion</button>\n  </form>\n</section>"

/***/ }),

/***/ "./src/app/shared/form-modules/login-form/login-form.component.ts":
/*!************************************************************************!*\
  !*** ./src/app/shared/form-modules/login-form/login-form.component.ts ***!
  \************************************************************************/
...
var LoginFormComponent = /** @class */ (function () {
    function LoginFormComponent() {
        ...
        this.formSubmission = function () {
            ...
            // Tester le email
            if (_this.formObject.email.length <= 1) {
                _this.formError.score++;
                _this.formError.email = true;
            }
            // Tester le password
            if (_this.formObject.password.length <= 4) {
                _this.formError.score++;
                _this.formError.password = true;
            }
            /*
    ...
    ], LoginFormComponent.prototype, "formObject", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ], LoginFormComponent.prototype, "sendFormData", void 0);
    LoginFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-login-form',
            template: __webpack_require__(/*! ./login-form.component.html */ "./src/app/shared/form-modules/login-form/login-form.component.html"),
            styles: []
        }),
...
/***/ "./src/app/shared/form-modules/register-form/register-form.component.html":
/*!********************************************************************************!*\
  !*** ./src/app/shared/form-modules/register-form/register-form.component.html ***!
  \********************************************************************************/
/*! no static exports found */
...
module.exports = "<!-- \nAfficher la section quand l'objet formObject à récupérer la valeur du parent\n-->\n<section *ngIf=\"formObject\">\n  <h2 (click)=\"formIsOpen = !formIsOpen\">Inscription</h2>\n  <!-- \n  Création d'un formuliare d'inscription\n  - Utilisation du ngModel pour le data binding des valeurs des inputs\n  -->\n  <form (submit)=\"formSubmission()\"  [ngClass]=\"{ 'open': formIsOpen }\" >\n    <label for=\"firstName\">Votre prénom <span *ngIf=\"formError.firstName\">Obligatoire</span></label>\n    <input type=\"text\" name=\"firstName\" [(ngModel)]=\"formObject.firstName\" (focus)=\"formError.firstName = false\">\n\n    <label for=\"lastName\">Votre nom  <span *ngIf=\"formError.lastName\">Obligatoire</span></label>\n    <input type=\"text\" name=\"lastName\" [(ngModel)]=\"formObject.lastName\" (focus)=\"formError.lastName = false\">\n\n    <label for=\"email\">Votre adresse mail  <span *ngIf=\"formError.email\">Obligatoire</span></label>\n    <input type=\"email\" name=\"email\" [(ngModel)]=\"formObject.email\" (focus)=\"formError.email = false\">\n\n    <label for=\"password\">Votre mot de passe  <span *ngIf=\"formError.password\">Obligatoire</span></label>\n    <input type=\"password\" name=\"password\" [(ngModel)]=\"formObject.password\" (focus)=\"formError.password = false\">\n\n    <label for=\"repeate-password\">Répéter votre mot de passe  <span *ngIf=\"formError.repeatePassword\">Différent</span></label>\n    <input type=\"password\" name=\"repeate-password\" [(ngModel)]=\"formObject.repeatePassword\"  (focus)=\"formError.repeatePassword = false\">\n\n    <input type=\"checkbox\" name=\"cgu\" [(ngModel)]=\"formObject.cgu\" (click)=\"checkConditions()\"> \n    Accepter les CGU  <span *ngIf=\"formError.cgu\">Obligatoire</span>\n\n    <button type=\"submit\">Inscription</button>\n  </form>\n</section>"

/***/ }),

/***/ "./src/app/shared/form-modules/register-form/register-form.component.ts":
/*!******************************************************************************!*\
  !*** ./src/app/shared/form-modules/register-form/register-form.component.ts ***!
  \******************************************************************************/
...
var RegisterFormComponent = /** @class */ (function () {
    function RegisterFormComponent() {
        ...
        this.checkConditions = function () {
            ...
            _this.formObject.cgu = !_this.formObject.cgu;
            // Vider l'erreur du span
            _this.formError.cgu = false;
        };
        // Création du fonction pour la soumission du formulaire
        this.formSubmission = function () {
            // Reset des erreur
            _this.resetFormError();
            // Tester le firstName
            if (_this.formObject.firstName.length <= 1) {
                _this.formError.score++;
                _this.formError.firstName = true;
            }
            // Tester le lastName
            if (_this.formObject.lastName.length <= 1) {
                _this.formError.score++;
                _this.formError.lastName = true;
            }
            // Tester le email
            if (_this.formObject.email.length <= 1) {
                _this.formError.score++;
            ...
            if (_this.formObject.password != _this.formObject.repeatePassword) {
                _this.formError.score++;
                _this.formError.repeatePassword = true;
            }
            // Tester les CGU
            if (!_this.formObject.cgu) {
                _this.formError.score++;
                _this.formError.cgu = true;
            }
            /*
            Validation finale du formulaire
            */
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], RegisterFormComponent.prototype, "formObject", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ], RegisterFormComponent.prototype, "sendFormData", void 0);
    RegisterFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-register-form',
            template: __webpack_require__(/*! ./register-form.component.html */ "./src/app/shared/form-modules/register-form/register-form.component.html"),
            styles: []
        })
        //
        /*
...
//# sourceMappingURL=pages-home-page-module~pages-todo-page-module.js.map